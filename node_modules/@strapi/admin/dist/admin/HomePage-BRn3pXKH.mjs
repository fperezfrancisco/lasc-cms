...
import { b as Layouts, v as ContentBox } from './index-DUWx-KG9.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-DTNQWeZ0.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-BRn3pXKH.mjs.map
