...
import { p as SETTINGS_LINKS_CE, b as Layouts } from './index-DUWx-KG9.mjs';
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import('./index-DUWx-KG9.mjs').then(n => n.K)).SETTINGS_LINKS_EE(),
    {
...
export { Layout };
//# sourceMappingURL=Layout-D9lATR6z.mjs.map
