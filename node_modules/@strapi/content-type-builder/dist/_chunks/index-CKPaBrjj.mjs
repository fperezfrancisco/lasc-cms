...
const ListView$1 = lazy(() => import("./ListView-C_cgtZD7.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-C_cgtZD7.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-CKPaBrjj.mjs.map
